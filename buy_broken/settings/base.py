"""
Django settings for buy_broken project.
...
ALLOWED_HOSTS = ['ecommerce-assignment-nexto123.c9users.io', 'buybucket.herokuapp.com']
...
WSGI_APPLICATION = 'buy_broken.wsgi.application'
